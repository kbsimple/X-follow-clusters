...
- [x] **REVIEW-03**: Support per-cluster actions: approve, reject, rename, merge with another cluster, split
- [ ] **REVIEW-04**: Batch actions: approve all clusters with >N members and confident names
- [x] **REVIEW-05**: Allow deferring a cluster without blocking others ("not sure yet")
